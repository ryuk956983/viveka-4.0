...
const Navbar = ({ setloader }) => {
  ...
  return (
    <div className="text-white bg-[#111c2c]  px-8 max-md:px-3  shadow-lg shadow-gray-900 rounded-xl">
      <div className="flex  w-full justify-between h-20 max-md:h-16 items-center">
        ...
        <div className="max-md:hidden">
          <ul className="flex gap-8 text-xl font-medium tracking-wide">
            <li
              className="hover:text-red-300 cursor-pointer px-1  ease-in-out "
              onClick={loaderTrue}
            >
              <Link to="/">Home</Link>
            </li>
            ...
            <li
              className="hover:text-white cursor-pointer px-1 ease-in-out text-red-500"
              onClick={loaderTrue}
            >
            ...
            <li className="hover:text-red-300 cursor-pointer px-1  ease-in-out">
              <a
                href="https://drive.google.com/file/d/1-9ddtb9tIOHKgax2Q8UuGMU3Jdcf4ILd/view"
                target="blank"
              >
                Brochure
              </a>
        ...
        <div
          className=" h-7 w-7 max-md:h-8 max-md:w-8 cursor-pointer hidden max-md:block "
          onClick={() => {
      ...
      <div
        className={`overflow-hidden transition-all h-0 ease-in-out duration-200 ${
          hamburger && "h-[300px]"
        }`}
      >
        <ul>
          <ul className="flex flex-col items-center py-4 gap-8 text-xl font-medium tracking-wider">
            <li
              className=" cursor-pointer px-1  ease-in-out  text-center "
              onClick={mobileLoaderTrue}
            >
              <Link to="/">Home</Link>
            </li>
            ...
            <li
              className=" cursor-pointer px-1 ease-in-out text-red-500 text-center"
              onClick={mobileLoaderTrue}
            >
              <Link to="/events">Events</Link>
            </li>
